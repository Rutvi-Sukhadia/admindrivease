        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				 <td> <a href="/admindrivease/user/viewUser/${v.userId}">${v.lenderName}</a></td>
...
                    <td>
                        <a href="/admindrivease/vehicle/viewVehicle/<c:out value='${v.vehicleId}' />">View All Details</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/admindrivease/booking/vehicleBookings/<c:out value='${v.vehicleId}' />">Bookings</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
 				</tr>
 				</c:forEach>
