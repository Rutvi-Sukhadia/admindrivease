...
                    <td>  <a href="/admindrivease/user/viewUser/<c:out value='${ad.userId}' />">View All Details</a> &ensp;            <a href="/admindrivease/booking/userBookings/<c:out value='${ad.userId}' />">Bookings</a>         <a href="/admindrivease/user/deleteUser/<c:out value='${ad.userId}' />">Delete</a></td>
 				</tr>
 				</c:forEach>
                               </tfoot>
              </table>
