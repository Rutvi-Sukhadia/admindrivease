			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 ><center>
								<font size="8"><a href="/admindrivease/user/viewUser/${driverUser.userId}">${driverUser.fname} ${driverUser.lname}</a></font>
							</center></h3><br>
						<div class="div1" style="float: left; margin-left: 30px;">
							<img
								src="/admindrivease/resources/images/userProfilePicture/${driverUser.profilePicture}"
								id="pic1" style="height: 400px; width: 350px;">
						</div>
						<div class="div2" style="float:left;margin-left: 10px;background: white; width:350px; ">
							<p>
								&nbsp;&nbsp;<b>Email:</b>&nbsp; ${driverUser.emailId} &nbsp; &nbsp;
								&nbsp; &nbsp; <br>
								<br> &nbsp;&nbsp;<b>Mobile Number:</b>${driverUser.mobileNo}<br>
								<br> &nbsp;&nbsp;<b>Date of Birth:</b>${driverUser.dob}<br>
								<br> &nbsp;&nbsp;<b>Preferable Vehicle Type:</b>&nbsp; ${driver.vehicleTypeName}
								<br>
								<br>&nbsp;&nbsp;<b>Hourly Rent:</b>${driver.hourlyRent}<br>
								<br> &nbsp;&nbsp;<b>Daily Rent:</b>${driver.dailyRent}<br>
								<br> &nbsp;&nbsp;<b>Description:</b>&nbsp; ${driver.description}<br>
								<br> &nbsp;&nbsp;<b>Pick up Address:</b>${driverUser.address}, ${driverUser.areaName}, ${driverUser.cityName}, ${driverUser.stateName}<br>
								<br>
							</p>
						</div>
							<div class="div3" style="float:left;margin-left: 5px; background: white;width:300px;">
								<p>
									&nbsp;&nbsp;<b>License Details</b><br>
									<br>&nbsp;&nbsp;<b>License Image &nbsp;</b><br>
									<img src="/admindrivease/resources/images/licensePicture/${driver.licensePicture}" id="pic2" style="height:200px;width:280px;" class="div4" style="float:left;margin-left:10px;"><br>
									<br>&nbsp;&nbsp;<b>License Issue Date:</b>${driver.dateOfIssue}<br>
									<br>&nbsp;&nbsp;<b>License Expiry Date::</b>${driver.dateOfExpiry}<br><br>
									<br>
								</p>
							</div>
					</div>
