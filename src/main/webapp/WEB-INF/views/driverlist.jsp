        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				 <td> <a href="/admindrivease/user/viewUser/${d.userId}">${d.driverName}</a></td>
                 <td><c:out value="${d.vehicleTypeName}" /></td>
                    <td>Rs.<c:out value="${d.hourlyRent}" />/Hour </td>
					<td> Rs.<c:out value="${d.dailyRent}" />/Day</td>
                    <td>
                        <a href="/admindrivease/driver/viewDriver/<c:out value='${d.driverId}' />">View All Details</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
						<a href="/admindrivease/booking/driverBookings/<c:out value='${d.driverId}' />">Bookings</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
 				</tr>
 				</c:forEach>
