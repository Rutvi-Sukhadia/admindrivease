				...
				<div class="box box-primary">
					<div class="box-header with-border">
						...
						<div class="div1" style="float: left; margin-left: 30px;">
							<img src="/admindrivease/resources/images/userProfilePicture/${user.profilePicture}" id="pic1" style="height: 400px; width:400px;">
						</div>
						<div class="div2" style="background: white; height: 400px;">
							...
							<div style="float: left; margin-left: 150px;">
								&nbsp;&nbsp;
								<center>
									<a href="/admindrivease/user/deleteUser/${user.userId}"><button style="width: 140px; height: 50px;">Delete
											USER</button></a>
								</center>
							</div>
							<div style="float: left; margin-left: 80px;">
								&nbsp;&nbsp;
								<center>
									<a href=""><button style="width: 140px; height: 50px;">SEND
											EMAIL</button></a>
								</center>
							</div>
						</div>
