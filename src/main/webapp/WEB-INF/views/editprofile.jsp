					...
					<form:form role="form" modelAttribute="admin1"
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div id="dvPreview">
												<img alt="" src="/admindrivease/resources/images/profilePicture/${admin1.profilePicture}" style="height:100px;width: 100px;">
											</div>
						...
						<div class="box-footer">
							<center>
									<input class="btn btn-primary" type="submit" value="Update"
										formaction="/admindrivease/admin/updateProfile" />
									<input class="btn btn-primary" type="submit" value="Cancel"
										formaction="/admindrivease/admin/home" />
										</center>
						</div>
