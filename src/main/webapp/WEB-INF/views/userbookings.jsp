...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <c:if test="${vehicle=='True'}">
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
                    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Vehicle Bookings</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				 <td><a href="/admindrivease/vehicle/viewVehicle/${v.vehicleId}">${v.vehicleNo}</a></td>
                    <td><c:out value="${v.vehicleName}" /></td>
					<td><c:out value="${v.startingDate}" /><br>To ${v.endingDate}</td>
...
                    </td>
    ...
    <div class="row">
        <div class="col-xs-12">
                    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Driver Bookings</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
                 <td><a href="/admindrivease/driver/viewDriver/${d.driverId}">${d.driverName}</a></td>
					<td><c:out value="${d.startingDate}" /><br>To ${d.endingDate}</td>
                 	<td>Rs.<c:out value="${d.finalAmount}" /></td>
                    <td>
                       ${d.status}
                    </td>
 				</tr>
