        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach var="b" items="${userBookingList}">
                
                <tr>
                 <td>${b.bookingId}</td>
                
				 <td> <a href="/admindrivease/user/viewUser/${b.userId}">${b.userName}</a></td>
                 	<td><c:out value="${b.startingDate}" /><br>To ${b.endingDate}</td>
                 	<td>Rs.<c:out value="${b.finalAmount}" /></td>
                    <td>
                       ${b.status}
                    </td>
 				</tr>
